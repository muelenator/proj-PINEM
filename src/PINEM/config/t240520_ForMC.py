...
config = {
    'file_name': 't240520_ForMC',
    'date': '24/05/2015',
    'author': 'rjm',
    'Number of electrons': 1,
    'Number of electron energies': 150,
    'Number of free space lengths': 1,
    'Maximum electron energy': wg['e_E_max_g'],
    'Electron energy range': 5e3,
    'Enforce phase': False,
    'Constant coupling': False,
    'Reference coupling': 0,
    'Phase reference': 1,
    'Phase minimum multiplier': .375,
    'Phase maximum multiplier': .376
}
##########################################################################################
...
# t_delay = 0 * Lfree
t_delay = Lfree / EnT_to_vvec(config['Maximum electron energy'],0,True)[2]
...
if not config['Constant coupling']:
    ...
    if config['Enforce phase']:
        ...
        for i, l in enumerate(Lfree):
            # Both cavities
            gQ[:,i,0] = e_c * vs * Ez_amp0 * Ez_ints1 / 2 / hbar_Js / wg['omega']
            gQ[:,i,1] = e_c * vs * Ez_amp0 * Ez_ints1 / 2 / hbar_Js / wg['omega']
